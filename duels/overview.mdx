...
Structurally, a Duel is just a two-person competition. It runs on the exact same trade screen, the exact same live Hyperliquid and Kraken price feeds, and the exact same **\$10,000 simulated practice balance** every player starts with. Nothing about the trading experience changes — what changes is the stakes, and how they get settled.
